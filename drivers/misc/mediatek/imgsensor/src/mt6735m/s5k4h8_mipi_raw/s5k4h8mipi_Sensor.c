...
{
    kal_uint16 get_byte=0; //zhangzhen
    char pusendcmd[2] = {(char)(addr >> 8) , (char)(addr & 0xFF) }; //zhangzhen
...
static void write_cmos_sensor(kal_uint16 addr, kal_uint16 para)
{
    ...
    char pusendcmd[4] = {(char)(addr >> 8) , (char)(addr & 0xFF) ,(char)(para >> 8),(char)(para & 0xFF)};//zhangzhen
    kdSetI2CSpeed(imgsensor_info.i2c_speed); // Add this func to set i2c speed by each sensor
...
{
    char pusendcmd[4] = {(char)(addr >> 8) , (char)(addr & 0xFF) ,(char)(para & 0xFF)};//zhangzhen
    kdSetI2CSpeed(imgsensor_info.i2c_speed); // Add this func to set i2c speed by each sensor
